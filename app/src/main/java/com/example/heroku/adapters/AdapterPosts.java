...
import com.example.heroku.AddPostActivity;
import com.example.heroku.PostDetailActivity;
...
public class AdapterPosts extends RecyclerView.Adapter<AdapterPosts.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        ...
        holder.pLikesTv.setText(pLikes +" Likes"); // 100 likes
        holder.pCommentsTv.setText(pComments + " Comments"); // 100 comments
        ...
        /*holder.profileLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                *//*click to go to UserProfileActivity with uid, this uid is of clicked user which will be used to show user specific data/posts*//*
    ...
    private void deleteWithoutImage(String pId) {
        ...
        fquery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(context, "Deleted with no image success", Toast.LENGTH_SHORT).show();
                pd.dismiss();
            }
